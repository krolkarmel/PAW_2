...
public class CalcBB {
	...
	public String doTheMath() {
	    try {
	        ...
	        if (y < 12) {
	            ctx.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Okres kredytowania musi być większy niż 12 miesięcy", null));
	            return null;
	        }
	        ...
	        return "showresult"; // Upewnij się, że istnieje strona o tej nazwie
